...
import { ViewMyLeaveDeteilsComponent } from '../components/my-leave/view/view-my-leave-deteils/view-my-leave-deteils.component';
...
import { LeaveManagementFormComponent } from '../components/my-leave/forms/leave-management-form/leave-management-form.component';
...
@NgModule({
  declarations: [
    ...
    ViewMyLeaveDeteilsComponent,
    MyLeaveDeteilsLayoutComponent,
    LeaveManagementComponent,
    LeaveManagementFormComponent
  ],
  imports: [
    CommonModule,
    LeaveRoutingModule,
