...
@Component({
  selector: 'app-view-out-post',
  templateUrl: './view-out-post.component.html',
  styleUrls: ['./view-out-post.component.css']
})
export class ViewOutPostComponent {
  ...
  ngOnInit(): void {
    ...
    this.getJobListApproved();
    this.getJobListRetturned();
    this.getJobListSuppervised();
  ...
  addJobList(){
    ...
    this.job_list.addJobList(this.cadre_Data).subscribe(
      res => {
  ...
  this.general.bfrcreating = false;
  this.general.creating = true;
  this.job_list.getJobListApproved().subscribe(
    res => {
...
// ================================================================
  ...
  getJobList() {
    this.general.bfrcreating = false;
    this.general.creating = true;
    this.job_list.getJobLists().subscribe(
      res => {
  ...
  commentJobListImmedietSuppervisor(id: any) {
    ...
    this.general.bfrcreating = false;
    this.general.creating = true;
    this.job_list.commentJobListImmedietSuppervisor(this.my_data).subscribe(
      res => {
        this.general.bfrcreating = true;
        this.general.creating = false;
        this.general.successMessage(res.sw_message, (e: any) => {
  ...
  getJobListRetturned() {
    this.general.bfrcreating = false;
    this.general.creating = true;
    this.job_list.getJobListRetturned().subscribe(
      res => {
