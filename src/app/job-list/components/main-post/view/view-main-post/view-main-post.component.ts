...
@Component({
  selector: 'app-view-main-post',
  templateUrl: './view-main-post.component.html',
  styleUrls: ['./view-main-post.component.css']
})
export class ViewMainPostComponent {
  approved: boolean = false;
  returned: boolean = false;
  suppervised: boolean = false;
  ...
  all_job_list_returned:any;
  all_job_list_suppervised:any;
  ...
  ngOnInit(): void {
    ...
    this.getCourtLevel()
    this.getMainJobListSuppervised();
    this.getMainJobListApproved();
    this.getMainJobListRetturned();
  ...
  addJobList(){
    ...
    this.job_list.addMainJobList(this.cadre_Data).subscribe(
      res => {
  ...
  this.general.bfrcreating = false;
  this.general.creating = true;
  this.job_list.getMainJobListApproved().subscribe(
    res => {
...
getMainJobListSuppervised() {
  this.general.bfrcreating = false;
  this.general.creating = true;
  this.job_list.getMainJobListSuppervised().subscribe(
    res => {
      this.all_job_list_suppervised = res;
      this.general.creating = false;
      this.general.bfrcreating = true;
    },
    err => {
...
getMainJobListRetturned() {
  this.general.bfrcreating = false;
  this.general.creating = true;
  this.job_list.getMainJobListRetturned().subscribe(
    res => {
      this.all_job_list_returned = res;
      this.general.creating = false;
      this.general.bfrcreating = true;
    },
    err => {
...
getJobListSuppervised() {
  this.general.bfrcreating = false;
  this.general.creating = true;
  this.job_list.getJobListSuppervised().subscribe(
    res => {
  ...
  approveJobList(id: any) {
    this.my_data.uid=id
    this.general.bfrcreating = false;
    this.general.creating = true;

    console.log('my id might',this.my_data);
    
    this.job_list.approveJobList(this.my_data).subscribe(
      res => {
        this.general.bfrcreating = true;
        this.general.creating = false;
        this.general.successMessage(res.sw_message, (e: any) => {
  ...
  rejectJobList(id: any) {
    this.my_data.uid=id
    this.general.bfrcreating = false;
    this.general.creating = true;
    this.job_list.rejectJobList(this.my_data).subscribe(
      res => {
        this.general.bfrcreating = true;
        this.general.creating = false;
        this.general.successMessage(res.sw_message, (e: any) => {
