...
@Component({
  selector: 'app-edit-main-post-form',
  templateUrl: './edit-main-post-form.component.html',
  styleUrls: ['./edit-main-post-form.component.css']
})
export class EditMainPostFormComponent {
  ...
  ngOnInit(): void {
    ...
    this.getCourtLevel();
    this.showMainJobLists();
  }

  showMainJobLists() {
    this.job_list_id.uid = this.submoduleId;
    this.job_list.showMainJobLists(this.job_list_id).subscribe(
      res => {
  ...
  editMainJobList(){
    ...
    this.job_list.editMainJobList(this.job_list_details).subscribe(
      res => {
        this.general.bfrcreating = true;
        this.general.creating = false;
        this.general.successMessage(res.sw_message, (e: any) => {
          this.route.navigate(['/main-post/' + this.job_list_details.uid]);
