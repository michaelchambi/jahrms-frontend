...
@Component({
  selector: 'app-self-bank-details-view',
  templateUrl: './self-bank-details-view.component.html',
  styleUrls: ['./self-bank-details-view.component.css']
})
export class SelfBankDetailsViewComponent {
  ...
  getBankInoDetails(id:any) {
    ...
    this.bank_info.showBankInfo(this.data_required).subscribe(
      res => {
