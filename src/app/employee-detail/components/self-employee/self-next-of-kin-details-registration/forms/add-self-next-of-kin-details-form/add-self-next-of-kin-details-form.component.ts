...
@Component({
  selector: 'app-add-self-next-of-kin-details-form',
  templateUrl: './add-self-next-of-kin-details-form.component.html',
  styleUrls: ['./add-self-next-of-kin-details-form.component.css']
})
export class AddSelfNextOfKinDetailsFormComponent {
