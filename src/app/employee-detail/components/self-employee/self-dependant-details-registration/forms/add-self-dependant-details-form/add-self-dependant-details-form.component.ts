...
@Component({
  selector: 'app-add-self-dependant-details-form',
  templateUrl: './add-self-dependant-details-form.component.html',
  styleUrls: ['./add-self-dependant-details-form.component.css']
})
export class AddSelfDependantDetailsFormComponent {
...
just_dependant:boolean=false;
  ...
  dependantRegistration() {
    ...
    this.dependant.addDependant(this.data).subscribe(
      res => {
        this.uid = res.data;
