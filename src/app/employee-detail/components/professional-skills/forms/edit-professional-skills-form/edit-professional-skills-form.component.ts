...
@Component({
  selector: 'app-edit-professional-skills-form',
  templateUrl: './edit-professional-skills-form.component.html',
  styleUrls: ['./edit-professional-skills-form.component.css']
})
export class EditProfessionalSkillsFormComponent {
