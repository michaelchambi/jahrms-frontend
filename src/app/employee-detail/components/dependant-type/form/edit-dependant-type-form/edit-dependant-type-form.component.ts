...
@Component({
  selector: 'app-edit-dependant-type-form',
  templateUrl: './edit-dependant-type-form.component.html',
  styleUrls: ['./edit-dependant-type-form.component.css']
})
export class EditDependantTypeFormComponent {
