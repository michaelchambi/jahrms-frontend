...
@Component({
  selector: 'app-edit-qualification-form',
  templateUrl: './edit-qualification-form.component.html',
  styleUrls: ['./edit-qualification-form.component.css']
})
export class EditQualificationFormComponent {
