...
@Component({
  selector: 'app-employee-retirement-view',
  templateUrl: './employee-retirement-view.component.html',
  styleUrls: ['./employee-retirement-view.component.css']
})
export class EmployeeRetirementViewComponent {
  ...
  getEmployee() {
    ...
    this.users.getAllEmployeeRetirements().subscribe(
      res => {
