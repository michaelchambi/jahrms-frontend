...
@Component({
  selector: 'app-edit-court-level-form',
  templateUrl: './edit-court-level-form.component.html',
  styleUrls: ['./edit-court-level-form.component.css']
})
export class EditCourtLevelFormComponent {
