...
@Component({
  selector: 'app-edit-next-of-kin-form',
  templateUrl: './edit-next-of-kin-form.component.html',
  styleUrls: ['./edit-next-of-kin-form.component.css']
})
export class EditNextOfKinFormComponent {
