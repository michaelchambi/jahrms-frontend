...
@Component({
  selector: 'app-edit-department-forms',
  templateUrl: './edit-department-forms.component.html',
  styleUrls: ['./edit-department-forms.component.css']
})
export class EditDepartmentFormsComponent {
