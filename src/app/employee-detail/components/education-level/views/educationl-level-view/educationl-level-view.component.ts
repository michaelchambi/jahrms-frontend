...
@Component({
  selector: 'app-educationl-level-view',
  templateUrl: './educationl-level-view.component.html',
  styleUrls: ['./educationl-level-view.component.css']
})
export class EducationlLevelViewComponent {
