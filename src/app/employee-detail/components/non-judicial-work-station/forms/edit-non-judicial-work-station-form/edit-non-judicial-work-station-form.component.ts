...
@Component({
  selector: 'app-edit-non-judicial-work-station-form',
  templateUrl: './edit-non-judicial-work-station-form.component.html',
  styleUrls: ['./edit-non-judicial-work-station-form.component.css']
})
export class EditNonJudicialWorkStationFormComponent {
