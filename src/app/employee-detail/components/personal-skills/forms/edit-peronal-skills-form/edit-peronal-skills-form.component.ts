...
@Component({
  selector: 'app-edit-peronal-skills-form',
  templateUrl: './edit-peronal-skills-form.component.html',
  styleUrls: ['./edit-peronal-skills-form.component.css']
})
export class EditPeronalSkillsFormComponent {
