...
@Component({
  selector: 'app-edit-district-form',
  templateUrl: './edit-district-form.component.html',
  styleUrls: ['./edit-district-form.component.css']
})
export class EditDistrictFormComponent {
