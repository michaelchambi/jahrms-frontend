...
@Component({
  selector: 'app-next-of-kin-details-view',
  templateUrl: './next-of-kin-details-view.component.html',
  styleUrls: ['./next-of-kin-details-view.component.css']
})
export class NextOfKinDetailsViewComponent {
