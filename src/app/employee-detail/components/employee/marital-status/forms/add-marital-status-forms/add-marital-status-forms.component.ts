...
@Component({
  selector: 'app-add-marital-status-forms',
  templateUrl: './add-marital-status-forms.component.html',
  styleUrls: ['./add-marital-status-forms.component.css']
})
export class AddMaritalStatusFormsComponent {
