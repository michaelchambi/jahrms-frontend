...
@Component({
  selector: 'app-view-first-designation-view',
  templateUrl: './view-first-designation-view.component.html',
  styleUrls: ['./view-first-designation-view.component.css']
})
export class ViewFirstDesignationViewComponent {
