  ...
  @Component({
    selector: 'app-view-appointment-view',
    templateUrl: './view-appointment-view.component.html',
    styleUrls: ['./view-appointment-view.component.css']
  })
  export class ViewAppointmentViewComponent {
