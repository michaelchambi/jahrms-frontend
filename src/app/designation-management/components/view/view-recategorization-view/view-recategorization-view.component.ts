  ...
  @Component({
    selector: 'app-view-recategorization-view',
    templateUrl: './view-recategorization-view.component.html',
    styleUrls: ['./view-recategorization-view.component.css']
  })
  export class ViewRecategorizationViewComponent {
