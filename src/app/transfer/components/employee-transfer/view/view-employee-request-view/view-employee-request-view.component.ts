...
@Component({
  selector: 'app-view-employee-request-view',
  templateUrl: './view-employee-request-view.component.html',
  styleUrls: ['./view-employee-request-view.component.css']
})
export class ViewEmployeeRequestViewComponent {
