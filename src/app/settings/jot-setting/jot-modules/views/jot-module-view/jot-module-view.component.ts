...
@Component({
  selector: 'app-jot-module-view',
  templateUrl: './jot-module-view.component.html',
  styleUrls: ['./jot-module-view.component.css']
})
export class JotModuleViewComponent implements OnInit {
  moduleList: any;
  module_data: any;
  submoduleId: any;
  data = {
