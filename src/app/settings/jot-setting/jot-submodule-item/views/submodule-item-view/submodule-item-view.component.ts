...
@Component({
  selector: 'app-submodule-item-view',
  templateUrl: './submodule-item-view.component.html',
  styleUrls: ['./submodule-item-view.component.css']
})
export class SubmoduleItemViewComponent {
  ...
  ngOnInit(): void {
    ...
    this.getSubmoduleModuleItems();
  }

  getSubmoduleModuleItems() {
    this.general.bfrcreating = false;
    this.general.creating = true;
    this.permission.getSubModuleItems().subscribe(
      res => {
