...
@Component({
  selector: 'app-jot-users-details-view',
  templateUrl: './jot-users-details-view.component.html',
  styleUrls: ['./jot-users-details-view.component.css']
})
export class JotUsersDetailsViewComponent implements OnInit {
