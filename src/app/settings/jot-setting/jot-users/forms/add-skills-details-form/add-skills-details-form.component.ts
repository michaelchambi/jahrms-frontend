...
@Component({
  selector: 'app-add-skills-details-form',
  templateUrl: './add-skills-details-form.component.html',
  styleUrls: ['./add-skills-details-form.component.css']
})
export class AddSkillsDetailsFormComponent {
