...
@Component({
  selector: 'app-edited-areas-item-view',
  templateUrl: './edited-areas-item-view.component.html',
  styleUrls: ['./edited-areas-item-view.component.css']
})
export class EditedAreasItemViewComponent {
  ...
  getBankInoDetails(id:any) {
    ...
    this.bank_info.showAreas(this.data_required).subscribe(
      res => {
